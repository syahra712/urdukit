...
LEXICON: dict[str, str] = {
    ...
    "میں": "mein", "ہم": "hum", "تم": "tum", "آپ": "aap", "وہ": "woh",
    "یہ": "yeh", "اس": "is", "ان": "un", "جو": "jo", "کون": "kaun",
    "کیا": "kya", "کیوں": "kyun", "کہاں": "kahan", "کب": "kab",
    "کیسے": "kaise", "کتنا": "kitna", "میرا": "mera", "میری": "meri",
    "تمہارا": "tumhara", "ہمارا": "hamara", "اپنا": "apna",
    # postpositions / conjunctions
    "کا": "ka", "کی": "ki", "کے": "ke", "کو": "ko", "نے": "ne",
    "سے": "se", "پر": "par", "تک": "tak", "اور": "aur", "یا": "ya",
    "لیکن": "lekin", "مگر": "magar", "کہ": "keh", "اگر": "agar",
    "تو": "to", "بھی": "bhi", "ہی": "hi", "نہ": "na", "نہیں": "nahi",
    "ساتھ": "sath", "بعد": "baad", "پہلے": "pehle", "لیے": "liye",
    # verbs / auxiliaries
    "ہے": "hai", "ہیں": "hain", "تھا": "tha", "تھی": "thi", "تھے": "the",
    "ہوں": "hun", "ہو": "ho", "ہوا": "hua", "ہوئی": "hui",
    "کرنا": "karna", "کرتا": "karta", "کرتی": "karti", "کرتے": "karte",
    "گیا": "gaya", "گئی": "gayi", "گئے": "gaye", "جانا": "jana",
    "آنا": "aana", "دیا": "diya", "لیا": "liya", "رہا": "raha",
    "رہی": "rahi", "رہے": "rahe", "سکتا": "sakta", "چاہیے": "chahiye",
    # very common nouns / adjectives
    "پاکستان": "pakistan", "اردو": "urdu", "کتاب": "kitab",
    "کتابیں": "kitabein", "گھر": "ghar", "پانی": "pani", "کھانا": "khana",
    "دوست": "dost", "لڑکا": "larka", "لڑکی": "larki", "آدمی": "aadmi",
    "عورت": "aurat", "بچہ": "bacha", "شہر": "shehar", "ملک": "mulk",
    "دن": "din", "رات": "raat", "سال": "saal", "وقت": "waqt",
    "کام": "kaam", "بات": "baat", "نام": "naam", "زندگی": "zindagi",
    "محبت": "mohabbat", "دل": "dil", "آنکھ": "aankh", "ہاتھ": "hath",
    "اچھا": "acha", "برا": "bura", "بڑا": "bara", "چھوٹا": "chota",
    "نیا": "naya", "پرانا": "purana", "بہت": "bohat", "زیادہ": "zyada",
    "کم": "kam", "سب": "sab", "کچھ": "kuch", "لوگ": "log",
    "اللہ": "allah", "سلام": "salam", "شکریہ": "shukriya",
    "کراچی": "karachi", "لاہور": "lahore", "اسلام": "islam",
    "دنیا": "duniya", "علم": "ilm", "سچ": "sach", "جھوٹ": "jhoot",
}
...
_ROMAN_TO_URDU = {
    "chh": "چھ", "kh": "کھ", "gh": "گھ", "bh": "بھ", "ph": "پھ",
    "th": "تھ", "jh": "جھ", "dh": "دھ", "ch": "چ", "sh": "ش",
    "aa": "ا", "ee": "ی", "oo": "و", "ai": "ے", "au": "و",
...
def _romanize_word(word: str) -> str:
    ...
    out: list[str] = []
    consonant_run = 0
    for index, (text, is_vowel) in enumerate(units):
